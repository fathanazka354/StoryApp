...
import com.fathan.storyapp.data.entity.RemoteKeys
...
//                Log.d("StoryRemoteMediator","responseData : $token")
//        try {
//            val responseData = apiService.getQuote("Bearer "+token,page, state.config.pageSize).listStory
//            val endOfPaginationReached = responseData.isEmpty()
//            database.withTransaction {
//                if (loadType == LoadType.REFRESH) {
//                    database.storyDao().deleteAll()
//                }
//                Log.d("StoryRemoteMediator","responseData : $responseData")
