...
import com.fathan.storyapp.ui.main.ListAdapter
...
class StoryRepositoryTest{
    ...
    fun `when Story Should Not Null`() = mainCoroutineRule.runBlockingTest {
        ...
        Mockito.`when`(storyRepository.getListStory()).thenReturn(story)
        val dataActual = storyRepository.getListStory().getOrAwaitValue()
